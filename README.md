...
- LLM evaluation and monitoring  
  Turning “is this model good” into something measurable and runnable: rubrics, judge reliability, drift monitoring, and failure modes that show up after deployment.

- Research engineering  
  Treating research like engineering: idea → experiment → results → paper, with a reproducible pipeline and clear documentation.

---

## Selected research and writing 📌

- ICLR 2026 CAO Workshop paper (poster; ratings: 6 / 7 / 8)  
